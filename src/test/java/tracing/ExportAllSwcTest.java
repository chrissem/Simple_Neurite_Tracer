...
public class ExportAllSwcTest {

	PathAndFillManager manager;
//	ImagePlus image;
//
...
//	double endX = 1.730; double endY = 13.554;
	...
	@Before public void setUp() {
	    manager = PathAndFillManager.createFromTracesFile("/Volumes/data/git/dermal_nerve_fibre_qantification/notebooks/data/bdf/20161019_P139_stack_1_0_cmle.traces");
//	    manager = new PathAndFillManager();
//	    manager.loadFromString("/Volumes/data/git/dermal_nerve_fibre_qantification/notebooks/data/bdf/20161019_P139_stack_1_0_cmle.traces");
...
//		if (image != null) image.close();
	...
	@Test
	public void testSwcExport() {
	    manager.exportAllAsSWC("_bla");
//
//		double pixelWidth = 1;
